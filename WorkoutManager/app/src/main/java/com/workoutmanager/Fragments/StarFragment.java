...
public class StarFragment extends Fragment implements DataHandler{
    ...
    @Override
    public void getData() {
        Call<List<User>> liked = retrofit.createClient().getStars(userId);
        liked.enqueue(new Callback<List<User>>() {
            @Override
